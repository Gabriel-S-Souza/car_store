...
class VehicleImageFieldWidget extends StatefulWidget {
  final Uint8List? initialImage;
  final void Function(Uint8List? image)? onImageSelected;

  const VehicleImageFieldWidget({
    super.key,
    this.initialImage,
  ...
  @override
  State<VehicleImageFieldWidget> createState() => _VehicleImageFieldWidgetState();
}

class _VehicleImageFieldWidgetState extends State<VehicleImageFieldWidget> {
  Uint8List? image;
